//I dont sure that create message by type is right cus i lazy to check...
...
var SERVER_CONNECTION = 0xB177A8; 
var PTHREAD_COND_WAKE_RETURN = 0x721064 + 8 + 1;
var CREATE_MESSAGE_BY_TYPE = 0x5C0BF0;
var POINTER_SIZE = 4;
...
rpc.exports = {
    init: function(stage, options) {
        ...
        onLoad('libg.so', function() {
            ...
            setup();
            toast("client made by tg@lazysavok");
        });
    }
};
